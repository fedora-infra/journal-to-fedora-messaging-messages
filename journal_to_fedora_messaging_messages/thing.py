...
from .base import SCHEMA_URL, JournaltoFedoraMessagingMessage, THING_SCHEMA


class NewThingV1(JournaltoFedoraMessagingMessage):
    """
    A sub-class of a Fedora message that defines a message schema for messages
    published by Journal to Fedora Messaging when a new thing is created.
    """

    topic = "journal-to-fedora-messaging.new"
