...
from journal_to_fedora_messaging_messages.thing import NewThingV1
...
def test_properties():
    ...
    assert message.app_name == "Journal to Fedora Messaging"
    assert (
        message.app_icon
        == "https://apps.fedoraproject.org/img/icons/journal-to-fedora-messaging.png"
    )
